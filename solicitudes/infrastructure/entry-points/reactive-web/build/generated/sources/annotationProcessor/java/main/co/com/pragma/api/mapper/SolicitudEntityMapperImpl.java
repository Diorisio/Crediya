...
public class SolicitudEntityMapperImpl implements SolicitudEntityMapper {
    ...
    public Solicitud toSolicitudEntity(Solicitud solicitudEntity) {
        ...
        solicitud.idSolicitud( solicitudEntity.getIdSolicitud() );
        ...
        solicitud.idEstado( solicitudEntity.getIdEstado() );
    ...
    public Solicitud toDomain(RequestSolicitud solicitud) {
        ...
        if ( solicitud.idTipoPrestamo() != null ) {
            solicitud1.idTipoPrestamo( solicitud.idTipoPrestamo().longValue() );
        }
